...
(Demucs vocal isolation + torchaudio wav2vec2 CTC forced alignment) lives
behind a Protocol in backends/ and is only imported on demand; install its
deps with setup-ai.sh.
"""
